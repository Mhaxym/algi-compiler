...
procedure YYParse is
   ...
   -- Rename User Defined Packages to Internal Names.
    ...
    package yy_shift_reduce_tables renames
      An_Sintactic_Shift_Reduce;
    package yy_tokens              renames
      An_Sintactic_Tokens;
    -- UMASS CODES :
    package yy_error_report renames
      An_Sintactic_Error_Report;
    -- END OF UMASS CODES.
...
when  9 =>
--#line  92
rs_nd_mode_parametre_in(
yyval);

when  10 =>
--#line  93
rs_nd_mode_parametre_out(
yyval);

when  11 =>
--#line  94
rs_nd_mode_parametre_inout(
yyval);
